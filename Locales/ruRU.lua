...
-- Settings: Debugger
L["DEBUGGER"] = "Отладчик"
L["DEBUGGER_DESC"] = "Устраняйте неполадки, временно отключив все аддоны, кроме ElvUI и MagguuUI."
L["DEBUG_MODE_STATUS"] = "Статус режима отладки"
L["DEBUG_MODE_ACTIVE"] = "Режим отладки |cff00ff88активен|r. Загружены только основные аддоны."
L["DEBUG_MODE_INACTIVE"] = "Режим отладки |cffff4444неактивен|r. Все аддоны загружены нормально."
L["ENABLE_DEBUG_MODE"] = "Включить режим отладки"
L["ENABLE_DEBUG_MODE_DESC"] = "Отключает все аддоны кроме ElvUI + MagguuUI и перезагружает интерфейс. Используйте для проверки, вызвана ли проблема другим аддоном."
L["DISABLE_DEBUG_MODE"] = "Выключить режим отладки"
L["DISABLE_DEBUG_MODE_DESC"] = "Повторно включает все ранее отключённые аддоны и перезагружает интерфейс."
L["DEBUG_ENABLED_COUNT"] = "%d аддонов отключено. Перезагрузка..."
L["DEBUG_DISABLED_COUNT"] = "%d аддонов включено. Перезагрузка..."
L["DEBUG_ALREADY_ACTIVE"] = "Режим отладки уже активен."
L["DEBUG_NOT_ACTIVE"] = "Режим отладки не активен."
L["DEBUG_STARTUP_WARNING"] = "Режим отладки активен — загружены только основные аддоны. Введите |cff4A8FD9/mui debug|r для выхода."
L["CMD_DEBUG"] = "Переключить режим отладки"
