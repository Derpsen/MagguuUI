local L = LibStub("AceLocale-3.0"):NewLocale("MagguuUI", "esMX")
...
L["CLASS_LAYOUTS_DESC3"] = "Reinstalar? Elimina primero los layouts antiguos manualmente en Advanced Cooldown Settings"
